        ...
        switch (opcao) { // verifica a opção selecionada pelo usuário
            ...
            printf("--------------------------- \n");
                ...
                while (opcao != 0) {
                                    ...
                                    printf("4 - Ver meios proximos\n");
                                    printf("5 - Ver historico de alugueis\n");
                ...
                break;
                        ...
                        case 5:
                            // Listar meios de mobilidade elétrica em uma localização
                                    ...
                                    inserirClienteG(g,"///crewcut.condense.perceive",500);
                                    inserirClienteG(g,"///deregulated.stress.oval",501);
                                    inserirClienteG(g,"///spied.contract.bounded",503);
                                    ...
                                    printf("Meios de transporte e clientes existentes na localizacao ///crewcut.condense.perceive\n");
                                    listarMeiosG(g,"///crewcut.condense.perceive");
                                    listarClientesG(g,"///crewcut.condense.perceive");
                                    printf("----------------\n");
                                    printf("Meios de transporte e clientes existentes na localizacao ///deregulated.stress.oval\n");
                                    listarMeiosG(g,"///deregulated.stress.oval");
                                    listarClientesG(g,"///deregulated.stress.oval");
                                    printf("----------------\n");
                                    /*printf("Meios de transporte e clientes existentes na localizacao ///spied.contract.bounded\n");
                                    listarMeiosG(g,"///spied.contract.bounded");
                                    listarClientesG(g,"///spied.contract.bounded");
                                    printf("----------------\n");
                                    printf("Meios de transporte e clientes existentes na localizacao ///slider.condors.roughness\n");
                                    listarMeiosG(g,"///slider.condors.roughness");
                                    listarClientesG(g,"///slider.condors.roughness");
                                    printf("----------------\n");*/
                            break;
                        case 6:
                            // Listar meios de mobilidade elétrica em uma localização
